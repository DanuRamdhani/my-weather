...
class WeatherByPlaceScreen extends StatefulWidget {
  const WeatherByPlaceScreen({super.key, required this.cityName});

  final String cityName;

  @override
  State<WeatherByPlaceScreen> createState() => _WeatherScreenState();
}

class _WeatherScreenState extends State<WeatherByPlaceScreen> {
  double lat = 0;
  double lon = 0;
